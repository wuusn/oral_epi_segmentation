function [gb_c,gb_s]=gaborkerns(theta,lambda,b,psi,gamma)
% GABORKERNS Generate Gabor kernels.
%   [GB_C,GB_S]=GABORKERNS(THETA,LAMBDA,B,PSI,GAMMA) calculates the cosine
