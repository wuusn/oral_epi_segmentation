small_src = '/mnt/md0/_datasets/OralCavity/WSI/ucsf/small_src' 
pred_src = '/mnt/md0/_datasets/OralCavity/tma@10_2/save/milesialx2_cb_again/ucsf_result' 
sub_slide_src = '/mnt/md0/_datasets/OralCavity/WSI/ucsf/sub_slide' 
anno_src = '/mnt/md0/_datasets/OralCavity/WSI/UCSF/Masks' 
save_dir = '/mnt/md0/_datasets/OralCavity/tma@10_2/save/milesialx2_cb_again/UCSF_pred' 
...
for small_path in small_paths:
    ...
    fname = f'{save_dir}/{name}_pred.png'
    if os.path.exists(fname):
        continue
    sub_anno = cv2.imread(f'{sub_slide_src}/{name}_anno.png', 0)
    pred = cv2.imread(f'{pred_src}/{name}_pred.png', 0)
